...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(React) {var
	immstruct = __webpack_require__(3),

	// UI components
	List = __webpack_require__(2),
	Panel = __webpack_require__(1).jsx;
	...
	function render () {
	    React.render(React.createElement(Panel, null, React.createElement(List.jsx, {cursor: structure.cursor('items')})), document.getElementById('boop'));

	    React.render(React.createElement(List.jsx, {cursor: structure.cursor('items')}), document.getElementById('boop2'));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = component(didMountMixin, function (props) {
	    ...
	    var items = cursor.map(function (item, key) {
	        ...
	        return React.createElement(Item.jsx, React.__spread({},  spread))
	    }).toArray();

	    var show = function() {
	        return items.length ? items : React.createElement("span", null, "No more items.");
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Structure = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = component(function (props, statics) {
	    ...
	    return (
	        React.createElement("div", {key: cursor.get('id')}, 
	            React.createElement("span", null, cursor.get('title')), 
	            React.createElement("span", null, cursor.get('text')), 
	            React.createElement("button", {onClick: deleteItem}, "Delete")
	        )
	    );
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React     = __webpack_require__(4),
	    deepEqual = __webpack_require__(39);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Immutable = __webpack_require__(97);
